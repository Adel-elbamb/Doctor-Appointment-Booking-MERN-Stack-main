       ...
       {!loading && !error &&    ( <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            ...
            <div className='mt-[50px]'>
              ...
              {tab === 'feedback' && <Feedback reviews = {reviews} averageRating = {averageRating} totalRating = {totalRating} />}
            </div>
          </div>

          <div>
            <SidePanel  timeSlots = {timeSlots}  ticketPrice = {ticketPrice} doctorId={_id}  />
          </div>
        </div>)}  
      </div>
    </section>
